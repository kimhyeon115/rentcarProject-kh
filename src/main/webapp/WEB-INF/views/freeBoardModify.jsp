...
<script type="text/javascript" src="/resources/js/freeBoardModify.js"></script>
</head>
<body>
			<%
					...
					<center>
					 	<table  border="0" cellspacing="0" cellpadding="10">
					 	  <h2 id="board_title">문의게시판</h2>
							<form action="freeBoardModifyOk" name="freeBoardModify_frm">
							<input type="hidden" name="rfbnum" value="${dto.rfbnum}">
								...
								<tr id="subject">
									...
									<td class="col2"><input type="text" name="rfbtitle" value="${dto.rfbtitle}"></td>
								</tr>
								<tr id="content">
									<td class="col1">글내용 :</td>
									<td class="col2"><textarea name="rfbcontent">${dto.rfbcontent}</textarea></td>
								</tr>
								<tr>
									<td colspan="2" align="center"><input class="contentbtn01"
										type="button" value="수정하기" onclick="freeBoardModifyCheck()">&nbsp;
