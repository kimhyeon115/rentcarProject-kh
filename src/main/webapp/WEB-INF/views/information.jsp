...
<%@ include file="include/header.jsp" %>
	<div class="l-ct">
		<div class="contents l-ct">
			...
			<h2 class="guideTitle">3.대여/반납 절차</h2>
			<div class="guideStep">
				<p class="stepSubject">렌터카 <span>대여</span> 절차</p>
				<ul>
					<li>
						<i class="used-icon-1"></i>
						<p>제주공항 1층 5번게이트<br>횡단보도 지난 후</p>
					</li>
					<li>
						<i class="used-icon-2"></i>
						<p>셔틀탑승구역<br>3구역 6번</p>
					</li>
					<li>
						<i class="used-icon-3"></i>
						<p>셔틀 탑승 후 7~10분<br>본사로 이동</p>
					</li>
					<li>
				...
				<ul>
					...
					<li>
						<i class="used-icon-7"></i>
						<p>셔틀 탑승 후 7~10분<br>공항으로 이동</p>
					</li>
					<li>
						<i class="used-icon-8"></i>
						<p>제주국제공항 <br>도착</p>
					</li>
				</ul>
			...
			<div class="guideRefund">
				...
				<div class="equipment-content">
					<p>환불/변경 신청은 유선상(064-742-0087)으로만 가능합니다.</p>
					<p>환불규정은 기간에 따라 환불 요금이 변동될 수 있으며, 당사 업무시간 내 (주중/주말 09:00~18:00 ) 에 취소 및 변경을 하셔야 적용됩니다.</p>
					<p>천재지변에 의해 취소가 될 경우에는 취소 확인할 수 있는 확인서(결항증명서)를 보내주셔야 취소 수수료 없이 환불이 가능합니다.</p>
				...
				<div class="equipment-content" style="padding: 0px; border: 0px;display: grid">
					...
					<ul>
						<li>인수일기준  2 ~ 3일전</li>
						<li>총 대여금의 20% 수수료부과</li>
					</ul>
					<ul>
						<li>인수일기준 1 ~ 당일</li>
						<li>총 대여금의 24시간 수수료부과</li>
					</ul>
				</div>
			</div>
