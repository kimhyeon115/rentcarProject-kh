				...
				<td class="contentbox">
					<center>
						...
						<table>
				          ...
				          <tr>
				            <td class="col1">${dtos.rbnum }</td>
				            <td class="col2">
				              <a href="userBoardView?rbnum=${dtos.rbnum }">${dtos.rbtitle}</a>&nbsp;&nbsp;&nbsp;
				              <c:if test="${dtos.rbreplycount != 0}">
				             	<span style="color:#999999;font-size: 9px;">[${dtos.rbreplycount}]</span>
				              </c:if>
				            </td>
				            <td class="col3">${dtos.rid }</td>
				            <td class="col4">
				   	         <c:out value="${fn:substring(dtos.rbdate,0,10) }"></c:out>
				            </td>
				            <td class="col5">${dtos.rbhit }</td>
				          </tr>
				          </c:forEach>
				        </table>
						<div id="buttons">
							<div class="col1"></div>
							<div class="col2">
								<a href="userBoardWrite"><img src="/resources/img/write.png"></a>
							</div>
						</div>
						<tr>
							<td colspan="5" align="center">
								...
								<c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="num">
									<c:choose>
										...
										<c:otherwise>
											<a href="userBoardList?pageNum=${num }">${num }</a>&nbsp;&nbsp;&nbsp;
										</c:otherwise>
									</c:choose>
								</c:forEach> 
