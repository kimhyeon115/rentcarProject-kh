...
public class PageDto {
	...
	public PageDto(Criteria criteria, int total) {
		 ...
		 this.endPage = (int) (Math.ceil(criteria.getPageNum()/(criteria.getPageGroup()*1.0))*criteria.getPageGroup()); //ceil -> 올림
		 //53개의 글이 존재
		 //    	1 2 3 4 5  next
		 // prev 6 7 8 9 10 next
		 // prev 11
		 this.startPage = this.endPage - (criteria.getPageGroup() - 1);
		 ...
		 this.prev = this.startPage > criteria.getPageGroup();
